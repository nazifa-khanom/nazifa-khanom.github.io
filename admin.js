...
const EDUCATION_PRESET_VALUES=["current","scholar-highlight","compact-timeline","split-panel","metric-grid","academic-profile","university-letterhead","merit-ribbon","bento-scholar","editorial-margin","stacked-bands"];
